...
description: my journey into networking, ip addressing, and subnetting for the 1337 curriculum.
...
## how to use
there is no code to compile for this project. you just run the provided index.html file in a web browser, load up the interactive levels from their respective json files[cite: 7], and start typing in the correct ip addresses and routing rules to make the network connections light up and work.
